...
public partial class Setting_Popup_Popup_ClientNewText_Excel : System.Web.UI.Page
{
    ...
    private void PageLoad()
    {
        ...
        DataTable dt = DacUser.ClientTextGetListForNews(conn, null, m_nStandardLanguageId, m_nLanguageId);
        ...
        string sFilePath = "Client_NewText" + sLanguageName + "_" + DateTimeUtil.ToDateTimeString(DateTime.Now) + ".xlsx";

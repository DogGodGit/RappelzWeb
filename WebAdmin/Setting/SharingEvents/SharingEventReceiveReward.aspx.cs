...
public partial class Setting_SharingEvents_SharingEventReceiveReward : System.Web.UI.Page
{
    ...
    private void PageLoad()
    {
        ...
        DataTable dt = DacUser.SharingEventReceiverRewards(conn, null, m_nRowsPerPage, m_nPage, out nTotCnt);
        ...
        try
        {
            ...
            switch (e.CommandName)
            {
                case "update":
                    ...
                    nRet = DacUser.UpdateSharingEventReceiverRewards(conn, null, nEventId, nRewardNo, nItemId, nItemCount, bOwned, "update");

                    break;
                case "delete":

                    nRet = DacUser.UpdateSharingEventReceiverRewards(conn, null, nEventId, nRewardNo, nItemId, nItemCount, bOwned, "delete");
    ...
    protected void WBtnAddSharingEventReceiverReward_OnClick(object sender, EventArgs e)
    {
        ...
        // 공유하기 이벤트 등록
        int nRetVal = DacUser.AddSharingEventReceiverRewards(conn, tran, nEventId, nRewardNo, nItemId, nItemCount, bOwned);
        ...
        ComUtil.MsgBox("작업성공", "location.href='/Setting/SharingEvents/SharingEventReceiveReward.aspx';");

<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Common/Master/Main.master" Codebehind="SharingEventSenderReward.aspx.cs" Inherits="Setting_SharingEvents_SharingEventSenderReward" %>
...
<div id="CONTENT_INNER">
    ...
    <h4>
        ...
        |
        <a href="/Setting/SharingEvents/SharingEventSenderReward.aspx" class="selected">발신자보상</a>
        |
    ...
    <p class="top_line"></p>
    <asp:Button ID="WBtnAddSharingEventSenderReward" Text="공유하기 발신자보상 등록" CssClass="button" OnClick="WBtnAddSharingEventSenderReward_OnClick"  runat="server" />

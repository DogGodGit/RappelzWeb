...
public partial class Setting_BlackIp : System.Web.UI.Page
{
    ...
    {
        WBtnAddIp.Attributes.Add("onclick", string.Format("return confirm('{0}');", "등록하시겠습니까?"));
        WBtnAddIp.Text = "IP 등록하기";
        WLabel.Text = "( " + ComUtil.GetIpAddress() + " )";
        //DB연결
        SqlConnection conn = DBUtil.GetUserDBConn();

        DataTable dtIp = DacUser.BlackIps(conn, null);
    ...
    protected void WRptList_OnItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        WBtnDel.Text = "삭제";
        WBtnDel.Attributes.Add("onclick", string.Format("return confirm('{0}');", "삭제하시겠습니까?"));
    }
    ...
    protected void WRptList_OnItemCommand(object sender, RepeaterCommandEventArgs e)
    {
        ...
        {
            case "delete":
                nRet = DacUser.DeleteBlackIp(conn, null, lnStartIpNo, lnEndIpNo);
                break;
        }
        ...
        else ComUtil.MsgBox("삭제되었습니다.", "location.href='" + Request.Url.ToString() + "';");
    ...
    protected void WBtnAddIp_OnClick(object sender, EventArgs e)
    {
        ...
        {
            ComUtil.MsgBox("IP 자릿수를 확인해주세요.", "historyback();");
            return;
        }
        ...
        {
            ComUtil.MsgBox("시작 IP 값이 마지막 IP 값보다 큽니다.", "historyback();");
            return;
        }
        ...
        //IP 등록
        int nRetVal = DacUser.AddBlackIp(conn, null, InStartIpNo, InEndIpNo, sStartIp, sEndIp, sName);
        ...
        else ComUtil.MsgBox("등록되었습니다.", "location.href='" + Request.Url.ToString() + "';");
    }

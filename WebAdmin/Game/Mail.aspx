<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Common/Master/Main.master" Codebehind="Mail.aspx.cs" Inherits="Game_Mail" %>
...
<div id="CONTENT_INNER">
	...
	<script type="text/javascript">
		...
		function sendMail() {
			...
			if (document.getElementById("<%=WTxtTarget.ClientID %>").value == '') {
				alert('발송대상을 입력해주세요.');
				document.getElementById("<%=WTxtTarget.ClientID %>").focus();
				return false;
			}
    ...
    <tr>
		<th><asp:DropDownList ID="WDDLType" runat="server" /></th>
        <td>
			<asp:TextBox ID="WTxtTarget" TextMode="MultiLine" onkeyup="ByteCheck(this)"  Width="200" Rows="10" runat="server" /> * 줄넘김으로 구분. <br /> 
			<asp:TextBox ID="WTxtByteCheck" Text="0" style="text-align:right;"  Width="27" runat="server"/>byte /7900 byte<br />
        </td>
    </tr>
    </table>
    <p class="bottom_line"></p>
    ...
    <asp:Button ID="WBtnMailSend" Text="우편 발송" OnClick="WBtnMailSend_OnClick" CssClass="button" runat="server" />

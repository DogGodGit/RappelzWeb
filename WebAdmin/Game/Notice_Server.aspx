<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Common/Master/Main.master" Codebehind="Notice_Server.aspx.cs" Inherits="Game_Notice_Server" %>
...
<div id="CONTENT_INNER">
    ...
    <h4>
        &nbsp;
        <a href="Notice_Server.aspx" class="selected">서버공지</a>
        |
        <a href="Notice_Global.aspx">글로벌공지</a>
    </h4>
    ...
    <asp:PlaceHolder ID="WHide" Visible="false" runat="server">
    <h3>서버공지 등록</h3>

...
public partial class Game_AccountHero : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        m_nAccountHeroId = ComUtil.GetRequestGuid("AHID", RequestMethod.Get);
    ...
    private void PageLoad()
    {
        ...
        DataTable drHeros = Dac.Heros_AccountId(conn, null, accountId);
    ...
    protected string GetDataItem(object objData, string sFieldNm)
    {
        ...
        switch (sFieldNm)
        {
            case "name":
                ...
                Guid result;
                ComUtil.TryParseGuid(ComUtil.GetDataItem(objData, "heroId"), out result);
                if (result == m_nAccountHeroId)

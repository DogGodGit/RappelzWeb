<%@ WebHandler Language="C#" Class="StatusLogging" %>
...
public class StatusLogging : IHttpHandler {
	...
	private string m_sPing = "";
	private string m_sFrameRate = "";
	private string m_sBatteryStatus = "";
	private string m_sChargeType = "";
	private string m_sNetworkType = "";
	private string m_sSignalStrength = "";
	...
	public void ProcessRequest(HttpContext context)
	{
		...
		try
		{
			...
			m_sPing = ComUtil.GetRequestString("ping", RequestMethod.Post, "");
			m_sFrameRate = ComUtil.GetRequestString("frameRate", RequestMethod.Post, "");
			m_sBatteryStatus = ComUtil.GetRequestString("batteryStatus", RequestMethod.Post, "");
			m_sChargeType = ComUtil.GetRequestString("chargeType", RequestMethod.Post, "");
			m_sNetworkType = ComUtil.GetRequestString("networkType", RequestMethod.Post, "");

			m_sSignalStrength = ComUtil.GetRequestString("signalStrength", RequestMethod.Post, "");
			m_sUserId = ComUtil.GetRequestString("userId", RequestMethod.Post, "");
			m_sHeroId = ComUtil.GetRequestString("heroId", RequestMethod.Post, "");
			...
			// 로깅
			//===============================================================================================
			int nRet = Dac.AddStatusLog(conn, null, m_sAppId, m_sUdid, m_sBrand, m_sModel, m_sOsName, m_sOsVersion, m_sVersion, m_sVersionCode, m_sLanguage, m_sCountry, m_sCpuUsage, m_sFreeMemory,
				m_sPing, m_sFrameRate, m_sBatteryStatus, m_sChargeType, m_sNetworkType, m_sSignalStrength, m_sUserId, m_sHeroId, m_sIpAddress);

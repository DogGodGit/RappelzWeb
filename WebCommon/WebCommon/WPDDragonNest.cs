...
public class WPDDragonNest : WPDPacketData
{
	...
	public override void Serialize(WPacketWriter writer)
	{
		...
		writer.Write(baseMaxStep);
		writer.Write(areaEffectPrefabName);
		writer.Write(areaEffectScale);
		writer.Write(trapPenaltyMoveSpeed);
		writer.Write(trapPenaltyDuration);
	...
	public override void Deserialize(WPacketReader reader)
	{
		...
		baseMaxStep = reader.ReadInt32();
		areaEffectPrefabName = reader.ReadString();
		areaEffectScale = reader.ReadSingle();
		trapPenaltyMoveSpeed = reader.ReadInt32();
		trapPenaltyDuration = reader.ReadInt32();
